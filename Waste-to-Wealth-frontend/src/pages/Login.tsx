...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Welcome back to Waste-to-Wealth!",
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-eco flex items-center justify-center p-4">
      <Card className="w-full max-w-md shadow-eco animate-scale-in">
        <CardHeader className="text-center">
          <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center mx-auto mb-4">
            <Recycle className="w-8 h-8 text-primary-foreground" />
          </div>
          <CardTitle className="text-3xl">Welcome Back</CardTitle>
          <CardDescription>Login to your Waste-to-Wealth account</CardDescription>
        </CardHeader>
        <CardContent>
